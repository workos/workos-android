...
import com.workos.android.enums.DirectoryUserWithGroupsState
...
@Serializable
public data class DirectoryUserWithGroups(
    ...
    @SerialName("state")
    public val state: DirectoryUserWithGroupsState,
    ...
    @Deprecated("This field is deprecated.")
    @SerialName("groups")
    public val groups: List<DirectoryGroup>,
    ...
    @Deprecated("This field is deprecated.")
    @SerialName("emails")
    public val emails: List<DirectoryUserWithGroupsEmail>? = null,
