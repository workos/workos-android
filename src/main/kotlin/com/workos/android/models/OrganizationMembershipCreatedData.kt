...
import com.workos.android.enums.OrganizationMembershipCreatedDataStatus
...
/** The event payload. */
@Serializable
public data class OrganizationMembershipCreatedData(
    ...
    @SerialName("status")
    public val status: OrganizationMembershipCreatedDataStatus,
