...
import com.workos.android.enums.UserOrganizationMembershipStatus
...
@Serializable
public data class UserOrganizationMembership(
    ...
    @SerialName("status")
    public val status: UserOrganizationMembershipStatus,
